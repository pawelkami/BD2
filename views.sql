...
CREATE OR REPLACE VIEW "PRACOWNICY INFORMACJE" AS
...
CREATE OR REPLACE VIEW "CZESCI SAMOCHODOWE W PLACOWCE" AS
...
CREATE OR REPLACE VIEW "CZESCI EKSPLOATACYJNE W PLACOWCE" AS
...
CREATE OR REPLACE VIEW "PRACOWNICY PLACOWEK" AS
SELECT P.imie, P.nazwisko, P."PESEL", P."id_PLACOWKA", P."login",
D."miasto", D."ulica", D."numer domu", D."numer lokalu", D."telefon"
FROM "PRACOWNIK" AS P JOIN "DANE KONTAKTOWE" AS D ON D."id" = P."id_DANE KONTAKTOWE";