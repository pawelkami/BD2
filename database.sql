...
--Sequences Initial
CREATE SEQUENCE "SEQ BADANIE OKRESOWE";
CREATE SEQUENCE "SEQ CZESC EKSPLOATACYJNA";
CREATE SEQUENCE "SEQ CZESC SAMOCHODOWA";
CREATE SEQUENCE "SEQ DANE KONTAKTOWE";
CREATE SEQUENCE "SEQ DYREKTOR";
CREATE SEQUENCE "SEQ HISTORIA NAPRAWY";
CREATE SEQUENCE "SEQ KIEROWNIK";
CREATE SEQUENCE "SEQ KLIENT INDYWIDUALNY";
CREATE SEQUENCE "SEQ KLIENT INSTYTUCJONALNY";
CREATE SEQUENCE "SEQ NAPRAWA";
CREATE SEQUENCE "SEQ PLACOWKA";
CREATE SEQUENCE "SEQ PRACOWNIK SZEREGOWY";
CREATE SEQUENCE "SEQ PRZYGOTOWANIE DO SEZONU";
CREATE SEQUENCE "SEQ RAPORT";
CREATE SEQUENCE "SEQ REZERWACJA";
CREATE SEQUENCE "SEQ RODZAJ CZESCI EKSPLOATACYJNEJ";
CREATE SEQUENCE "SEQ RODZAJ CZESCI SAMOCHODOWEJ";
CREATE SEQUENCE "SEQ SAMOCHOD";
CREATE SEQUENCE "SEQ SERWIS";
CREATE SEQUENCE "SEQ SERWIS MAGAZYN";
CREATE SEQUENCE "SEQ SKIEROWANIE NA BADANIE";
CREATE SEQUENCE "SEQ WYPOZYCZALNIA";
CREATE SEQUENCE "SEQ WYPOZYCZENIE";
CREATE SEQUENCE "SEQ ZAMOWIENIE WEWNETRZNE";
CREATE SEQUENCE "SEQ ZAMOWIENIE ZEWNETRZNE";
CREATE SEQUENCE "SEQ ZEWNETRZNY DOSTAWCA";
CREATE SEQUENCE "SEQ ZGLOSZENIE";
CREATE SEQUENCE "SEQ ZGLOSZENIE ZEWNETRZNE";
...
CREATE TABLE public."KLIENT INDYWIDUALNY"(
	id integer NOT NULL DEFAULT nextval('SEQ KLIENT INDYWIDUALNY'),
...
CREATE TABLE public."KLIENT INSTYTUCJONALNY"(
	id integer NOT NULL DEFAULT nextval('SEQ KLIENT INSTYTUCJONALNY'),
...
CREATE TABLE public."DANE KONTAKTOWE"(
	id integer NOT NULL DEFAULT nextval('SEQ DANE KONTAKTOWE'),
...
CREATE TABLE public."KIEROWNIK"(
	id integer NOT NULL DEFAULT nextval('SEQ KIEROWNIK'),
...
CREATE TABLE public."DYREKTOR"(
	id integer NOT NULL DEFAULT nextval('SEQ DYREKTOR'),
...
CREATE TABLE public."PRACOWNIK SZEREGOWY"(
	id integer NOT NULL DEFAULT nextval('SEQ PRACOWNIK SZEREGOWY'),
	dzial public.rodzaj_dzialu NOT NULL,
...
CREATE TABLE public."PLACOWKA"(
	id integer NOT NULL DEFAULT nextval('SEQ PLACOWKA'),
	"id_DANE KONTAKTOWE" integer NOT NULL,
...
CREATE TABLE public."SERWIS MAGAZYN"(
	id integer NOT NULL DEFAULT nextval('SEQ SERWIS MAGAZYN'),
	"id_PLACOWKA" integer NOT NULL,
...
CREATE TABLE public."SERWIS"(
	id integer NOT NULL DEFAULT nextval('SEQ SERWIS'),
	"id_PLACOWKA" integer NOT NULL,
...
CREATE TABLE public."WYPOZYCZALNIA"(
	id integer NOT NULL DEFAULT nextval('SEQ WYPOZYCZALNIA'),
	"id_PLACOWKA" integer NOT NULL,
...
CREATE TABLE public."CZESC SAMOCHODOWA"(
	id integer NOT NULL DEFAULT nextval('SEQ CZESC SAMOCHODOWA'),
...
CREATE TABLE public."RODZAJ CZESCI SAMOCHODOWEJ"(
	id integer NOT NULL DEFAULT nextval('SEQ RODZAJ CZESCI SAMOCHODOWEJ'),
...
CREATE TABLE public."CZESC EKSPLOATACYJNA"(
	id integer NOT NULL DEFAULT nextval('SEQ CZESC EKSPLOATACYJNA'),
...
CREATE TABLE public."RODZAJ CZESCI EKSPLOATACYJNEJ"(
	id integer NOT NULL DEFAULT nextval('SEQ RODZAJ CZESCI EKSPLOATACYJNEJ'),
	rodzaj varchar(32) NOT NULL,
...
CREATE TABLE public."ZAMOWIENIE ZEWNETRZNE"(
	id integer NOT NULL DEFAULT nextval('SEQ ZAMOWIENIE ZEWNETRZNE'),
...
CREATE TABLE public."ZEWNETRZNY DOSTAWCA"(
	id integer NOT NULL DEFAULT nextval('SEQ ZEWNETRZNY DOSTAWCA'),
...
CREATE TABLE public."ZGLOSZENIE"(
	id integer NOT NULL DEFAULT nextval('SEQ ZGLOSZENIE'),
...
CREATE TABLE public."BADANIE OKRESOWE"(
	id integer NOT NULL DEFAULT nextval('SEQ BADANIE OKRESOWE'),
...
CREATE TABLE public."PRZYGOTOWANIE DO SEZONU"(
	id integer NOT NULL DEFAULT nextval('SEQ PRZYGOTOWANIE DO SEZONU'),
	"id_ZGLOSZENIE" integer NOT NULL,
...
CREATE TABLE public."NAPRAWA"(
	id integer NOT NULL DEFAULT nextval('SEQ NAPRAWA'),
	"id_ZGLOSZENIE" integer NOT NULL,
	myjnia boolean NOT NULL,
	jazda_probna boolean NOT NULL,
...
CREATE TABLE public."RAPORT"(
	id integer NOT NULL DEFAULT nextval('SEQ RAPORT'),
	"id_ZGLOSZENIE" integer NOT NULL,
	"id_PRACOWNIK SZEREGOWY" integer NOT NULL,
...
CREATE TABLE public."ZGLOSZENIE ZEWNETRZNE"(
	id integer NOT NULL DEFAULT nextval('SEQ ZGLOSZENIE ZEWNETRZNE'),
	"id_ZGLOSZENIE" integer NOT NULL,
...
CREATE TABLE public."ZAMOWIENIE WEWNETRZNE"(
	id integer NOT NULL DEFAULT nextval('SEQ ZAMOWIENIE WEWNETRZNE'),
	"id_ZGLOSZENIE" integer NOT NULL,
	"id_SERWIS MAGAZYN" integer NOT NULL,
	"id_PRACOWNIK SZEREGOWY" integer NOT NULL,
...
CREATE TABLE public."SAMOCHOD"(
	id integer NOT NULL DEFAULT nextval('SEQ SAMOCHOD'),
...
CREATE TABLE public."SKIEROWANIE NA BADANIE"(
	id integer NOT NULL DEFAULT nextval('SEQ SKIEROWANIE NA BADANIE'),
...
CREATE TABLE public."HISTORIA NAPRAWY"(
	id integer NOT NULL DEFAULT nextval('SEQ HISTORIA NAPRAWY'),
	"id_SAMOCHOD" integer NOT NULL,
	opis varchar(255),
	data timestamp NOT NULL,
	"id_NAPRAWA" integer,
...
CREATE TABLE public."WYPOZYCZENIE"(
	id integer NOT NULL DEFAULT nextval('SEQ WYPOZYCZENIE'),
...
-- object: "WYPOZYCZENIE_uq" | type: CONSTRAINT --
-- ALTER TABLE public."WYPOZYCZENIE" DROP CONSTRAINT IF EXISTS "WYPOZYCZENIE_uq" CASCADE;
ALTER TABLE public."WYPOZYCZENIE" ADD CONSTRAINT "WYPOZYCZENIE_uq" UNIQUE ("id_KLIENT INDYWIDUALNY");
-- ddl-end --
...
CREATE TABLE public."REZERWACJA"(
	id integer NOT NULL DEFAULT nextval('SEQ REZERWACJA'),
...
-- object: "REZERWACJA_uq" | type: CONSTRAINT --
-- ALTER TABLE public."REZERWACJA" DROP CONSTRAINT IF EXISTS "REZERWACJA_uq" CASCADE;
ALTER TABLE public."REZERWACJA" ADD CONSTRAINT "REZERWACJA_uq" UNIQUE ("id_KLIENT INDYWIDUALNY");
-- ddl-end --
...
-- object: "WYPOZYCZENIE_uq1" | type: CONSTRAINT --
-- ALTER TABLE public."WYPOZYCZENIE" DROP CONSTRAINT IF EXISTS "WYPOZYCZENIE_uq1" CASCADE;
ALTER TABLE public."WYPOZYCZENIE" ADD CONSTRAINT "WYPOZYCZENIE_uq1" UNIQUE ("id_SAMOCHOD");
-- ddl-end --
