...
-- object: "ZAMOWIENIE WEWNETRZNE_uq1" | type: CONSTRAINT --
-- ALTER TABLE public."ZAMOWIENIE WEWNETRZNE" DROP CONSTRAINT IF EXISTS "ZAMOWIENIE WEWNETRZNE_uq1" CASCADE;
ALTER TABLE public."ZAMOWIENIE WEWNETRZNE" ADD CONSTRAINT "ZAMOWIENIE WEWNETRZNE_uq1" UNIQUE ("id_PRACOWNIK SZEREGOWY");
-- ddl-end --
